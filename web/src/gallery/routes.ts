...
export const galleryRoutes: GalleryRoute[] = [
  ...
  { path: "components/skills", title: "Skill components", group: "Components", artifact: "design-system/components/skills.html" },
  { path: "components/admin-table", title: "User table", group: "Components", artifact: "design-system/components/admin-table.html" },
  ...
  { path: "compositions/profile", title: "Profile", group: "Compositions", artifact: "profile/profile.html", bare: true },
  { path: "compositions/skills-edit", title: "Edit skills", group: "Compositions", artifact: "skills/skills-edit.html", bare: true },
  { path: "compositions/admin-users", title: "Admin users", group: "Compositions", artifact: "admin/users.html", bare: true },
  { path: "compositions/login", title: "Sign in", group: "Compositions", artifact: "auth/login.html", bare: true },
  { path: "compositions/onboarding", title: "Onboarding basics", group: "Compositions", artifact: "onboarding/basics.html", bare: true },
  { path: "compositions/resume-upload", title: "Resume import", group: "Compositions", artifact: "resume/upload.html", bare: true },
  { path: "compositions/resume-generated", title: "Generated resume preview", group: "Compositions", artifact: "resume/generated.html", bare: true },
